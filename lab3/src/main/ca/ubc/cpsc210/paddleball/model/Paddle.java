...
public class Paddle {
    ...
    private void dealWithIt() {
        if (integerX - DIMENSION1 / 2 < 0) {
            integerX = DIMENSION1 / 2;
        } else if (integerX + DIMENSION1 / 2 > PBG.DIMENSION1) {
            integerX = PBG.DIMENSION1 - DIMENSION1 / 2;
        }
    }
}
